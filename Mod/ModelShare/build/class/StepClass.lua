...
use the lib:
------------------------------------------------------------
NPL.load("(gl)Mod/ModelShare/build/class/StepClass.lua");
local StepClass = commonlib.gettable("Mod.ModelShare.build.class.StepClass");
------------------------------------------------------------
]]
...
local StepClass = commonlib.inherit(nil, commonlib.gettable("Mod.ModelShare.build.class.StepClass"));
